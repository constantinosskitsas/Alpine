...
class RepMethod():
    def __init__(self,
        ...
        # number of buckets to split node feature values into #CURRENTLY BASE OF LOG SCALE
        self.num_buckets = num_buckets
        self.normalize = normalize  # whether to normalize node embeddings
        # parameter weighing structural similarity in node identity
...
class Graph():
    ...
    def __init__(self,
        ...
        # N x A matrix, where N is # of nodes, and A is # of attributes
        self.node_attributes = node_attributes
        self.kneighbors = None  # dict of k-hop neighbors for each node
        # dict of true alignments, if this graph is a combination of multiple graphs
