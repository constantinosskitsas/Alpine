...
def get_features(graph, rep_method, verbose=False):
...
def get_sample_nodes(graph, rep_method, verbose=False):
...
def get_feature_dimensionality(graph, rep_method, verbose=False):
...
def get_representations(graph, rep_method, verbose=False):
